...
//             }
            steps {
                sh '''
                    ...
                    git remote set-url origin-ssh git@github.com:TimothyFothergill/jenkins-workshop.git || git remote add origin-ssh git@github.com:TimothyFothergill/jenkins-workshop.git
                    git fetch --all
                    git checkout master
